...
// desktop
export const camera_position_1 = new THREE.Vector3(-0.05, -3.53, 3.58); // HERO Start
export const cameraLookAt_1 = new THREE.Vector3(-0.04, 0.91, 1.37);

export const camera_position_2 = new THREE.Vector3(-0.03, 2.32, 6.13); // HERO Front
export const cameraLookAt_2 = new THREE.Vector3(-0.04, 0.91, 1.37);

export const camera_position_3 = new THREE.Vector3(3.43, 3.4, 3.88); // Pioneering engineering
export const cameraLookAt_3 = new THREE.Vector3(-0.04, 0.88, 1.37);

export const camera_position_4 = new THREE.Vector3(4.45, 0.1, 0.78); // Looks tough. Because it is.
export const cameraLookAt_4 = new THREE.Vector3(-0.05, 0.51, 1.38);

export const camera_position_5 = new THREE.Vector3(1.66, -0.46, -2.18); // 49mm titanium case
export const cameraLookAt_5 = new THREE.Vector3(0.51, 0.54, 1.5);

export const camera_position_6 = new THREE.Vector3(-1.88, -0.25, -1.63); // Tested to MIL-STD 810H3
export const cameraLookAt_6 = new THREE.Vector3(-0.05, 0.55, 1.89);

export const camera_position_7 = new THREE.Vector3(-3.1, 0.9, 1.4); // Ready for Action.
export const cameraLookAt_7 = new THREE.Vector3(0.09, 0.35, 1);

export const camera_position_8 = new THREE.Vector3(-1.17, -0.02, 3.42); // Go above and beyond
export const cameraLookAt_8 = new THREE.Vector3(0.24, 0.45, 1.12);

export const camera_position_9 = new THREE.Vector3(1.67, 1.93, 3.04); // Everything to love about Apple Watch.
export const cameraLookAt_9 = new THREE.Vector3(-0.01, 0.75, 1.22);

export const camera_position_10 = new THREE.Vector3(5.11, 4.2, 5.31); // customize
export const cameraLookAt_10 = new THREE.Vector3(0.58, 0.65, 0.86);

export const camera_position_11 = new THREE.Vector3(-4.41, 5.3, 6.1); // customizing
export const cameraLookAt_11 = new THREE.Vector3(-0.18, 0.07, 0.38);
...
export const camera_position_11_mobile = new THREE.Vector3(-4.41, 5.3, 6.1); // customizing
export const cameraLookAt_11_mobile = new THREE.Vector3(-0.18, 0.07, 0.38);
